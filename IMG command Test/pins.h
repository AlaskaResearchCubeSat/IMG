...
#define CAM_TX_PIN       BIT0
#define CAM_RX_PIN       BIT1
#define CAM_TX_PIN_NUM   0 //want TX in RX pin and RX in TX pin
#define CAM_RX_PIN_NUM   1
#define CAM_PINS         (CAM_RX_PIN|CAM_TX_PIN)
#define CAM_PORT         4
